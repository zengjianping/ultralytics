...
TRACKER_MAP = {"bytetrack": BYTETracker, "botsort": BOTSORT, "balltrack": BallTracker}
...
def on_predict_start(predictor: object, persist: bool = False) -> None:
    ...
    if cfg.tracker_type not in TRACKER_MAP.keys():
        raise AssertionError(f"Only {list(TRACKER_MAP.keys())} are supported for now, but got '{cfg.tracker_type}'")
